...
name=load('trimmed_Steel_Point.mat','-ASCII');
...
a0=fminsearch(@fn_Steel_Point_analysis_0,aguess)
a1=fminsearch(@fn_Steel_Point_analysis_1,aguess)
a2=fminsearch(@fn_Steel_Point_analysis_2,aguess)
a3=fminsearch(@fn_Steel_Point_analysis_3,aguess)
a4=fminsearch(@fn_Steel_Point_analysis_4,aguess)
a5=fminsearch(@fn_Steel_Point_analysis_5,aguess)
a6=fminsearch(@fn_Steel_Point_analysis_6,aguess)
a7=fminsearch(@fn_Steel_Point_analysis_7,aguess)
...
t1='Fitted Point Heat Data Steel - ';
